...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <p><strong>Родительская:</strong> {{ $category->getParent->name }}</p>
    ...
    <a href="{{ route('admin.category.create', ['parent' => $category->id]) }}" class="btn btn-success">
    ...
    <a href="{{ route('admin.product.category', ['category' => $category->id]) }}" class="btn btn-info">
        Товары категории
    </a>
    <hr>
